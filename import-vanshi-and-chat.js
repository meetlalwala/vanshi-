...
// Clear existing memories to rebuild cleanly
db.memories = [];
...
// Assemble memories: Videos -> Chat Images -> Vanshi Images
db.memories = [...vanshiVideos, ...chatItems, ...vanshiImages];

db.memories.forEach(m => delete m.isVideo);

fs.writeFileSync(dbPath, JSON.stringify(db, null, 2));
console.log("Successfully rebuilt database with Vanshi photos/videos and chat photos!");
